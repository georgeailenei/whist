...
class ValidateCards:
    ...
    def check_right_suit(
        self, card: str, player_cards: list, suit: str, trump_card: str
    ):
        s = -1
        ...
        if suit is None:
            ...
            card[s] != suit
            and card[s] != trump_card
            and suit not in player_suits
            and trump_card not in player_suits
        ):
            return True
        else:
            return False
