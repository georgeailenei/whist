...
class Controller:
    ...
    def save_game(self, players, board, score_one, score_two, trump_card):
        ...
        players_tricks = [players[player1].tricks, players[player2].tricks, players[player3].tricks, players[player4].tricks]
        players_removed_cards = [players[player1].remove_cards, players[player2].remove_cards, players[player3].remove_cards, players[player4].remove_cards]

        self.repository.save_all(players_names, players_cards, players_tricks, board, score_one, score_two, trump_card, players_removed_cards)
    ...
    def load_game(self):
        if self.repository.get_all() == "empty_file":
            ...
            self.repository.save_all(players_names, players_cards, players_tricks, board, score_one, score_two, trump_card, removed_players_cards)
            self.repository.get_all()
            return {
                'players_names': self.repository.players_names, 
                'players_cards': self.repository.hands, 
                'players_tricks': self.repository.tricks, 
                'board': self.repository.board,
                'scores': [self.repository.score_one, self.repository.score_two], 
                'trump_card': self.repository.trump_card,
                'removed_players_cards': self.repository.removed_players_cards,
            }
        else:
            self.repository.get_all()
            return {
